DROP TABLE D2L_GRADE_BOOK_SETTING_LOAD;

CREATE TABLE D2L_GRADE_BOOK_SETTING_LOAD (
...
CREATE UNIQUE INDEX D2L_GRADE_BOOK_SETTING_LOAD_PK ON D2L_GRADE_BOOK_SETTING_LOAD (
  OrgUnitId,
  GradeSchemeId
);
