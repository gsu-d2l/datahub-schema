...
CREATE TABLE D2L_USER (
  ...
  SourcedId NVARCHAR2(512) DEFAULT NULL,  
  SisSourcedId VARCHAR2(16 CHAR) DEFAULT NULL,
  SisPIDM NUMBER(8,0) DEFAULT NULL,
  SisPersonId VARCHAR2(9 CHAR) DEFAULT NULL
);
...
CREATE INDEX IDX_D2L_USER_SOURCEDID ON D2L_USER(SourcedId);
CREATE INDEX IDX_D2L_USER_SISSOURCEDID ON D2L_USER(SisSourcedId);
CREATE INDEX IDX_D2L_USER_SISPIDM ON D2L_USER(SisPIDM);
CREATE INDEX IDX_D2L_USER_SISPERSONID ON D2L_USER(SisPersonId);
