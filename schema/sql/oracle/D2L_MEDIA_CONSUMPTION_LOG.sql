DROP TABLE D2L_MEDIA_CONSUMPTION_LOG;

CREATE TABLE D2L_MEDIA_CONSUMPTION_LOG (
...
CREATE UNIQUE INDEX D2L_MEDIA_CONSUMPTION_LOG_PK ON D2L_MEDIA_CONSUMPTION_LOG (
  LogId
);
