...
CREATE TABLE D2L_QUIZ_ATTEMPT_LOAD (
  ...
  TimeLimitExceededBehaviour NVARCHAR2(256) DEFAULT NULL,
  IsSynchronous NUMBER(1) DEFAULT NULL,
  DeductionPercentage NUMBER(10) DEFAULT NULL
);

CREATE UNIQUE INDEX D2L_QUIZ_ATTEMPT_LOAD_PK ON D2L_QUIZ_ATTEMPT_LOAD (
  AttemptId
);
